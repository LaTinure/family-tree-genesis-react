...
import { TreePine, Users, Heart, Shield, Crown, LogIn, UserPlus } from 'lucide-react';
      ...
      <section className="pt-20 pb-16 px-4">
        <div className="max-w-6xl mx-auto text-center">
          <div className="flex flex-col items-center justify-center mb-8">
            ...
            <h1 className="text-5xl font-bold text-gray-900 mb-4">Famille Connect</h1>
