            ...
            <div className="flex justify-center mb-2">
              <div className="relative">
                ...
                <div className="absolute bottom-0 right-0 flex space-x-1">
                  <label className="w-6 h-6 bg-whatsapp-500 rounded-full flex items-center justify-center cursor-pointer hover:bg-whatsapp-600 transition-colors">
                  ...
                  <label className="w-6 h-6 bg-blue-500 rounded-full flex items-center justify-center cursor-pointer hover:bg-blue-600 transition-colors">
              ...
              <div className="flex items-center space-x-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-yellow-800 text-sm">
                    Vous êtes le premier membre de la famille ! Vous serez automatiquement défini comme 
                    <span className="font-semibold"> {watchedTitle === 'M.' ? 'Patriarche' : 'Matriarche'}</span> 
                    ...
                    onClick={() => {
                      if (adminCode === '1432') {
                        ...
                        toast({
                          ...
                          description: "Le code administrateur est invalide.",
                          variant: "destructive",
                        });
                      }
                    }}
          ...
          >
            {isLoading ? (
              <>
                ...
                {isFirstUser ? 'Création de l\'arbre familial...' : 'Inscription en cours...'}
              </>
            ) : (
              <>
                <UserPlus className="mr-2 h-4 w-4" />
                {isFirstUser ? '🌳 Créer l\'arbre familial' : 'Rejoindre la famille'}
              </>
            )}
          </Button>
        </form>
