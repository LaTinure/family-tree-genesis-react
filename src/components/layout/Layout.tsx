...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***{showHeader***REMOVED***&&***REMOVED***user***REMOVED***&&***REMOVED***<Header***REMOVED***/>}
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***<main***REMOVED***className={`flex-1***REMOVED***${showHeader***REMOVED***&&***REMOVED***user***REMOVED***?***REMOVED***'pt-20'***REMOVED***:***REMOVED***''}`}>
