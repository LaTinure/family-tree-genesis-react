...
import {
  Menu, X, Facebook, Twitter, Instagram, Linkedin, MessageCircle, Star,
  Settings, UserPlus, Flag, MessageSquare, LogOut, TreePine, Users,
  Shield, Loader2, User, Bell, Calendar, Database
} from 'lucide-react';
...
const Header = () => {
  ...
  const handleDeleteAll = async () => {
    ...
    setIsDeleting(true);
    try {
      // Appel à la fonction Supabase pour supprimer toutes les données
