        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center space-x-8">
            ...
            >
              ...
              <div>
                <motion.h1
                  className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-white to-whatsapp-100 inline-flex items-center justify-center"
                ...
                >
                  ...
                  <sup className="ml-2 align-super">
                    <Star
                      className={`w-6 h-6 text-yellow-400 drop-shadow-lg transition-opacity duration-500 ${
                ...
                <motion.p
                  className="text-sm text-whatsapp-100/80"
                  initial={{ opacity: 0 }}
                  animate={{ opacity: 1 }}
            ...
            {user && (
              <div className="hidden md:flex items-center space-x-4">
                ...
                <Button
                  ...
                  className={`flex items-center gap-2 px-3 py-2 rounded-lg transition-all duration-200 text-sm ${
                    isActiveRoute(ROUTES.DASHBOARD.MEMBERS)
                      ? 'bg-white/20 text-white'
                      : 'text-white/80 hover:text-white hover:bg-white/10'
                  }`}
                >
                ...
                <Button
                  ...
                  className={`flex items-center gap-2 px-3 py-2 rounded-lg transition-all duration-200 text-sm ${
                    isActiveRoute(ROUTES.DASHBOARD.INVITE)
                      ? 'bg-white/20 text-white'
                      : 'text-white/80 hover:text-white hover:bg-white/10'
                  }`}
                >
            ...
            {user && profile && (
              <DropdownMenu>
                <DropdownMenuTrigger asChild>
                  <Button variant="ghost" className="relative h-auto px-3 py-2 rounded-full hover:bg-white/10 text-white">
