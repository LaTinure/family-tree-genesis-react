...
***REMOVED******REMOVED***const***REMOVED***{***REMOVED***data:***REMOVED***invitationData,***REMOVED***isLoading,***REMOVED***error***REMOVED***}***REMOVED***=***REMOVED***useQuery({
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***dynasties***REMOVED***(
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***dynasty_name:***REMOVED***data.dynasties?.name***REMOVED***||***REMOVED***'Dynastie***REMOVED***inconnue'
