...
import***REMOVED***type***REMOVED***{***REMOVED***Profile***REMOVED***}***REMOVED***from***REMOVED***'@/types/profile';
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***Convertir***REMOVED***les***REMOVED***profils***REMOVED***en***REMOVED***membres***REMOVED***de***REMOVED***famille***REMOVED***avec***REMOVED***des***REMOVED***valeurs***REMOVED***par***REMOVED***défaut***REMOVED***sécurisées
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***civilite:***REMOVED***(profile.civilite***REMOVED***as***REMOVED***FamilyMember['civilite'])***REMOVED***||***REMOVED***'M.',
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***birth_date:***REMOVED***profile.birth_date***REMOVED***||***REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***birth_place:***REMOVED***profile.birth_place***REMOVED***||***REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***current_location:***REMOVED***profile.current_location***REMOVED***||***REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***situation:***REMOVED***profile.situation***REMOVED***||***REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***avatar_url:***REMOVED***profile.avatar_url***REMOVED***||***REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***father_id:***REMOVED***profile.father_id***REMOVED***||***REMOVED***null,
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***mother_id:***REMOVED***profile.mother_id***REMOVED***||***REMOVED***null,
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***setMembers([]);***REMOVED***//***REMOVED***S'assurer***REMOVED***que***REMOVED***members***REMOVED***n'est***REMOVED***jamais***REMOVED***undefined
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***//***REMOVED***Convertir***REMOVED***les***REMOVED***données***REMOVED***en***REMOVED***type***REMOVED***FamilyMember
...
***REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED******REMOVED***civilite:***REMOVED***data.civilite***REMOVED***as***REMOVED***FamilyMember['civilite'],
