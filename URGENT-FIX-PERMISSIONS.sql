--***REMOVED***URGENT:***REMOVED***Fix***REMOVED***permission***REMOVED***denied***REMOVED***for***REMOVED***dynasty_creation_tokens
...
--***REMOVED***2.***REMOVED***Vérifier***REMOVED***que***REMOVED***les***REMOVED***tables***REMOVED***existent
SELECT
***REMOVED******REMOVED***table_name,
***REMOVED******REMOVED***rowsecurity***REMOVED***as***REMOVED***rls_enabled
FROM***REMOVED***pg_tables
WHERE***REMOVED***table_name***REMOVED***IN***REMOVED***('profiles',***REMOVED***'dynasty_creation_tokens',***REMOVED***'dynasties')
