-- Migration finale corrigée pour les utilisateurs temporaires
...
-- 5. Supprimer et recréer les politiques (sans IF NOT EXISTS)
...
-- 8. Test d'insertion avec user_id temporaire
